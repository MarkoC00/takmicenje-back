...
{
    internal class EkipnoKateEntityTypeConfiguration : IEntityTypeConfiguration<EkipnoKate>
    {
        public void Configure (EntityTypeBuilder<EkipnoKate> builder)
        {
            builder.ToTable("ekipno_kate");
